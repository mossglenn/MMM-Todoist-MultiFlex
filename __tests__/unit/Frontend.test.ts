...
describe('Frontend', () => {
  it('should register client implementation', () => {
    ...
    expect(name).toBe('MMM-Todoist-MultiFlex');
  ...
  describe('getStyles overriden function', () => {
    it('should return correct styles', () => {
      ...
      // when-then
      expect(getStyles()).toEqual(['/file/css/MMM-Todoist-MultiFlex.css']);
    });
  });
  ...
  describe('getTemplate overriden function', () => {
    it('should return correct template', () => {
      ...
      // when-then
      expect(getTemplate()).toEqual('templates/MMM-Todoist-MultiFlex.njk');
    });
  });
});
