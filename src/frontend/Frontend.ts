...
Module.register<Config>('MMM-Todoist-MultiFlex', {
  // Default module config
  defaults: {
    text: 'Now this is Podracing! Hello World!',
  },
   ...
   */
  getStyles() {
    return [this.file('css/MMM-Todoist-MultiFlex.css')];
  },

  // MM function: loads template
  getTemplate(): string {
    return 'templates/MMM-Todoist-MultiFlex.njk';
  },
